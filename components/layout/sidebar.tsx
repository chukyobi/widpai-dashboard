...
import { BarChart3, MessageSquare, Shield, LogOut, CreditCard, FileText, Settings, Users } from "lucide-react"
  ...
  return (
    <>
      ...
      <div className="hidden md:flex h-full w-60 flex-col glass border-r shadow-xl relative z-10 flex-shrink-0">
        ...
        <div className="flex-1 overflow-auto py-4">
          ...
          <nav className="grid gap-0.5 px-2 text-sm font-medium">
            ...
            <Link href="/customers" className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-muted-foreground transition-all hover:bg-primary/10 hover:text-primary active:scale-95">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around border-t border-border/50 bg-card/80 backdrop-blur-xl py-2">
        ...
        <Link href="/customers" className="flex flex-col items-center gap-0.5 px-3 py-1 rounded-xl text-muted-foreground hover:text-primary transition-colors active:scale-95">
